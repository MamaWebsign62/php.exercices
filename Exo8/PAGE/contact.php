        		...
        		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                    <tbody>
                        <div>
                            ...
                            <input style="width:100%;" type="text" name="nom" id="nom" required/>
                        </div>

                        <div style="margin-top:20px;">
                        	<label for="prenom">* Votre prénom :</label><br><br>
                       		<input style="width:100%;" type="text" name="prenom" id="prenom" required/>
                        </div>

                        <div style="margin-top:20px;">
                        	<label for="mail">* Votre email :</label><br><br>
                            <input style="width:100%;" type="text" name="mail" id="mail" required/>
                        </div>

                        <div style="margin-top:20px;">
                        	<label for="subject">* Votre sujet :</label><br><br>
                            <input style="width:100%;" type="text" name="objet" id="objet" required/>
                        </div>

                        <div style="margin-top:20px;">
                        	<label>* Votre message :</label><br><br>
                            <textarea name="message" id="message" rows="10" cols="50" placeholder="Message..." style="width:100%;"></textarea>
                        </div>
